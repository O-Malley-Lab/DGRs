...
if __name__ == '__main__':
    ...
    ##OPTION PARSER##
    parser = argparse.ArgumentParser(description='Takes a gbk with manually annotated misc_features and CDS, and an input annotated gbk from NCBI, extracts the manual annotation from the first gbk and adds them to the annotated gbk as misc_feature or transfers manual annotation if a match is found betewen 2 CDS (exact same location).',
